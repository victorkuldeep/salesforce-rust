 ...
 * @param {number} handle
 */
export function drop_engine(handle) {
 ...
 * @returns {string}
 */
export function execute_query(handle, query) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function execute_query_json(items_json, query) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @returns {number}
 */
export function init_engine(items_json) {
    const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {number}
 */
export function init_engine_with_indexes(items_json, indexes_json) {
    const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {number}
 */
export function init_engine_with_options(items_json, options_json) {
    const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function search_json(items, query) {
    const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function search_json_string(items_json, query) {
    const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @param {string} items_json
 */
export function update_engine(handle, items_json) {
    const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
