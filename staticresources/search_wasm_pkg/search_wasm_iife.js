var searchWasm = (function (exports) {
    'use strict';
     ...
     * @returns {any}
     */
    function aggregate_handle(handle, spec_json) {
        const ptr0 = passStringToWasm0(spec_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.aggregate_handle(handle, ptr0, len0);
        if (ret[2]) {
     ...
     * @returns {string}
     */
    function aggregate_handle_json(handle, spec_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(spec_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.aggregate_handle_json(handle, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {any}
     */
    function aggregate_json(items_json, spec_json) {
        ...
        const ret = wasm.aggregate_json(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {string} field
     */
    function create_index(handle, field) {
        const ptr0 = passStringToWasm0(field, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.create_index(handle, ptr0, len0);
        if (ret[1]) {
     ...
     * @param {string} field
     */
    function drop_index(handle, field) {
        const ptr0 = passStringToWasm0(field, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.drop_index(handle, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @returns {any}
     */
    function engine_cache_stats(handle) {
        const ret = wasm.engine_cache_stats(handle);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {string}
     */
    function execute_query(handle, query) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.execute_query(handle, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {any}
     */
    function execute_query_indices(handle, query) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.execute_query_indices(handle, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {string}
     */
    function execute_query_json(items_json, query) {
        let deferred4_0;
        let deferred4_1;
        try {
            const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            ...
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.execute_query_json(ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
     ...
     * @returns {string}
     */
    function execute_query_paged(handle, query) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.execute_query_paged(handle, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    function get_engine_data_size(handle) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.get_engine_data_size(handle);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {any}
     */
    function get_metrics(handle) {
        const ret = wasm.get_metrics(handle);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {number}
     */
    function init_engine(items_json) {
        const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
     ...
     * @returns {number}
     */
    function init_engine_from_bytes(bytes, options_json) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(options_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.init_engine_from_bytes(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     * @returns {number}
     */
    function init_engine_with_indexes(items_json, indexes_json) {
        const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.init_engine_with_indexes(ptr0, len0, indexes_json);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     * @returns {number}
     */
    function init_engine_with_options(items_json, options_json) {
        const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(options_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.init_engine_with_options(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     * @returns {any}
     */
    function list_indexes(handle) {
        const ret = wasm.list_indexes(handle);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    function search_json(items, query) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.search_json(items, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    function search_json_string(items_json, query) {
        const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.search_json_string(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {string} items_json
     */
    function update_engine(handle, items_json) {
        const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.update_engine(handle, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    function validate_query(query) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.validate_query(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    async function __wbg_init(module_or_path) {
        ...
        if (module_or_path === undefined) {
            module_or_path = new URL('search_wasm_bg.wasm', (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('search_wasm_iife.js', document.baseURI).href));
        }
        const imports = __wbg_get_imports();
    ...
    exports.aggregate_handle = aggregate_handle;
    exports.aggregate_handle_json = aggregate_handle_json;
    exports.aggregate_json = aggregate_json;
    exports.create_index = create_index;
    exports.default = __wbg_init;
    exports.drop_engine = drop_engine;
    exports.drop_index = drop_index;
    exports.engine_cache_stats = engine_cache_stats;
    exports.engine_version = engine_version;
    exports.execute_query = execute_query;
    exports.execute_query_indices = execute_query_indices;
    exports.execute_query_json = execute_query_json;
    exports.execute_query_paged = execute_query_paged;
    exports.get_engine_data_size = get_engine_data_size;
    exports.get_metrics = get_metrics;
    exports.initSync = initSync;
    exports.init_engine = init_engine;
    exports.init_engine_from_bytes = init_engine_from_bytes;
    exports.init_engine_with_indexes = init_engine_with_indexes;
    exports.init_engine_with_options = init_engine_with_options;
    exports.list_indexes = list_indexes;
    exports.search_json = search_json;
    exports.search_json_string = search_json_string;
    exports.set_query_cache_size = set_query_cache_size;
    exports.update_engine = update_engine;
    exports.validate_query = validate_query;
